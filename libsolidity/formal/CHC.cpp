...
void CHC::endVisit(FunctionDefinition const& _function)
{
	...
	// This connects the current block to the current return block
	// and makes the return block the current block.
	popInlineFrame(&_function);
